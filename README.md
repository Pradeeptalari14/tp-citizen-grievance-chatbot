# 🏛️ All-India Citizen Grievance Chatbot
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/citizen-grievance-chatbot/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-citizen-grievance-chatbot.git
cd tp-citizen-grievance-chatbot
```
...
```bash
kubectl port-forward deployment/tp-citizen-grievance-chatbot 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── citizen_grievance.json     # Main configuration file
```
...
---
*Generated by [All-India Citizen Grievance Chatbot Studio](https://pradeeptalari14.github.io/portfolio/tools/citizen-grievance-chatbot/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
